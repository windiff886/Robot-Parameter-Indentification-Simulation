...
private:
  ...
  void saturation_callback(const std_msgs::msg::Bool::SharedPtr msg);
  ...
  rclcpp::Subscription<std_msgs::msg::Bool>::SharedPtr saturation_sub_;
  rclcpp::TimerBase::SharedPtr timer_;

  // ========== 数据记录 ==========
  std::ofstream data_file_;
  bool recording_{false};
  std::atomic<bool> is_saturated_{false};
  double simulation_time_{0.0};
  std::size_t record_count_{0};
  static constexpr std::size_t FLUSH_INTERVAL = 1000; // Flush every 1000 samples
